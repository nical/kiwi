...
class DumbFilter : public kiwi::core::Filter{
public:
  void process(){
...
class StaticDumbFilter : public kiwi::core::Filter{
public:
  void process(){
    // PROCESS
    // use _readA, etc.
...
/* Then:
 *
 * SNType aStaticNode = makeStaticNode<StaticDymmyFilter>(StaticDumbFilter)
 */ 
